...
std::string diretorioModelos = "../M4_AtividadeVivencial/objetos/";
...
//#endif
	...
	Shader shader = Shader("../M4_AtividadeVivencial/shaders/hello.vs", "../M4_AtividadeVivencial/shaders/hello.fs");
